...
const EmailSMSTemplates = ({ onSave }) => {
  ...
  const handleSMSSubmit = (values) => {
    console.log("SMS Templates:", values);
    onSave();
  };
    ...
    >
      <Tabs activeKey={activeTab} onChange={setActiveTab}>
        <TabPane
          ...
          key="email"
        >
          <Form form={emailForm} layout="vertical" onFinish={handleEmailSubmit} initialValues={{
            ...
            <Card title="Order Confirmation Email" className="mb-4">
              <Form.Item
            ...
            <Card title="Order Shipped Email" className="mb-4">
              <Form.Item
            ...
            <Card title="Order Delivered Email" className="mb-4">
              <Form.Item
            ...
            <Card title="Password Reset Email" className="mb-4">
              <Form.Item
            ...
            <Card title="Email Settings" className="mb-4">
              <Form.Item
            ...
            <Card title="Available Variables" className="mb-4">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                {templateVariables.map((variable, index) => (
                  <div key={index} className="p-2 bg-gray-50 rounded text-sm">
                    <code className="text-blue-600">{variable.value}</code>
        ...
        <TabPane
          ...
          key="sms"
        >
          <Form form={smsForm} layout="vertical" onFinish={handleSMSSubmit} initialValues={{
            ...
            <Card title="Order Confirmation SMS" className="mb-4">
              <Form.Item
            ...
            <Card title="Order Shipped SMS" className="mb-4">
              <Form.Item
            ...
            <Card title="Order Delivered SMS" className="mb-4">
              <Form.Item
            ...
            <Card title="OTP SMS" className="mb-4">
              <Form.Item
                name="otpSMS"
                label="SMS Template"
                rules={[{ required: true, message: "Please enter SMS template" }]}
            ...
            <Card title="SMS Settings" className="mb-4">
              <Form.Item
